...
plot.new()
legend('topleft', pch=1, title = 'Control', bty='n',
       col = c('green','red','purple'), 
       legend = c('Pre-op','0hr Post-CPB','24hr Post-CPB'))
legend('top', pch=16, title = 'Mild VS', bty='n',
       col = c('green','red','purple'), 
       legend = c('Pre-op','0hr Post-CPB','24hr Post-CPB'))
legend('topright', pch=15, title = 'Severe VS', bty='n',
       col = c('green','red','purple'), 
       legend = c('Pre-op','0hr Post-CPB','24hr Post-CPB'))

legend('left', pch=1, bty='n',
       col = c('blue','orange','brown4'), 
       legend = c('Healthy Control','MMP8- Septic Shock','MMP8+ Septic Shock'))
